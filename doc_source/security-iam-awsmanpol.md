...
View details about updates to AWS managed policies for Amazon FSx since this service began tracking these changes\. For automatic alerts about changes to this page, subscribe to the RSS feed on the Amazon FSx [Document History for Amazon FSx for NetApp ONTAP](document-history.md) page\.
